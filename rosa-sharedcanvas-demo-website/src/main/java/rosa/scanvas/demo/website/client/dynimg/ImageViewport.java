...
public class ImageViewport extends Composite {
    ...
    private final AbstractImageServer server;
    ...
    public ImageViewport(AbstractImageServer server, int width, int height) {
        this.server = server;
    ...
    private void zoomChanged() {
        ...
        if (tiles == null) {
            tiles = server.renderToTiles(master, canvas_width, canvas_height);
