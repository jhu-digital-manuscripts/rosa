...
public class RoseCollection {
	...
	public class ImageList {
		...
		public String iiifServiceUrl(int i) {
	          ...
	          return "http://rosetest.library.jhu.edu/iiif/rose%2F"
              + bookid + "%2F" + image + "/full/300,/0/native.jpg";
		}
	...
	public static class ImageTagging {
		 ...
		 */
		private List<Integer> findIllusIndexes(int image) {
		...
		public String description(int image) {
			StringBuilder sb = new StringBuilder();

			for (int illus : findIllusIndexes(image)) {
